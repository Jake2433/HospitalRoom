package com.example.kyb24.hospitalroom.Bluetooth;

/**
 * Created by kyb24 on 2017-11-13.
 */
...
import com.example.kyb24.hospitalroom.R;
...
public class DataListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((bluetoothAdapter = BluetoothAdapter.getDefaultAdapter()) == null) {
            Toast.makeText(DataListActivity.this, "Bluetooth is not supported", Toast.LENGTH_SHORT).show();
        }
        ...
        buttonConnect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (chat == null) {
                    ...
                    startActivityForResult(new Intent(DataListActivity.this, DeviceListActivity.class), REQUEST_CONNECT_DEVICE);
                } else {
                    chat.close();
                }
            }
